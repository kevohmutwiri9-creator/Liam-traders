...
function HomeContent() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-600 via-teal-700 to-cyan-800 flex items-center justify-center py-12 px-4 relative overflow-hidden">
